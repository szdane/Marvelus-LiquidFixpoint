...
close_out oc;
let t_left_ast = {var = "x"; base=TInt; pred=Bin (Lt, Var "x", Var "k")} in
let t_right_ast = {var = "y"; base=TInt; pred=Bin (Lt, Var "y", Var "u")} in
let r =
  { var  = "v"
  ; base = TInt
...
in
print_endline (Refinement_ast.string_of_refinement t_left_ast);
